...
path_save='Z:\Hassaan\HE_Scanner\Standard_Normal\Testing_LM_comparison_stained_unstained\stained_core_bigger_dataset\Texton_separate_valandtrain\';
train_textons_glandwise(1,50);
train_textons_glandwise(2,50);
train_textons_glandwise(3,50);
getting_texton_image_glandwise(0,1,50);
getting_texton_image_glandwise(1,1,50);
getting_texton_image_glandwise(0,2,50);
getting_texton_image_glandwise(1,2,50);
getting_texton_image_glandwise(0,3,50);
getting_texton_image_glandwise(1,3,50);
generate_histograms_threefold_glandwise(0,0,1,50);
generate_histograms_threefold_glandwise(1,0,1,50);
generate_histograms_threefold_glandwise(0,0,2,50);
generate_histograms_threefold_glandwise(1,0,2,50);
generate_histograms_threefold_glandwise(0,0,3,50);
generate_histograms_threefold_glandwise(1,0,3,50);
...
%}
[feature3_ordered_benign_tr12,feature3_ordered_malignant_tr12,PCA_coeff_1,index_1]=gen_feature_three_tr(feature3_tr12_benign,feature3_tr12_malignant);
[feature3_ordered_benign_val1,feature3_ordered_malignant_val1]=gen_feature_three_val(feature3_val1_benign,feature3_val1_malignant,PCA_coeff_1,index_1);
[feature3_ordered_benign_tr23,feature3_ordered_malignant_tr23,PCA_coeff_2,index_2]=gen_feature_three_tr(feature3_tr23_benign,feature3_tr23_malignant);
[feature3_ordered_benign_val2,feature3_ordered_malignant_val2]=gen_feature_three_val(feature3_val2_benign,feature3_val2_malignant,PCA_coeff_2,index_2);
[feature3_ordered_benign_tr13,feature3_ordered_malignant_tr13,PCA_coeff_3,index_3]=gen_feature_three_tr(feature3_tr13_benign,feature3_tr13_malignant);
[feature3_ordered_benign_val3,feature3_ordered_malignant_val3]=gen_feature_three_val(feature3_val3_benign,feature3_val3_malignant,PCA_coeff_3,index_3);


feature_tr12_benign=[feature1_tr12_benign' feature2_tr12_benign' feature3_ordered_benign_tr12];
feature_val1_benign=[feature1_val1_benign' feature2_val1_benign' feature3_ordered_benign_val1];
feature_tr12_malignant=[feature1_tr12_malignant' feature2_tr12_malignant' feature3_ordered_malignant_tr12];
feature_val1_malignant=[feature1_val1_malignant' feature2_val1_malignant' feature3_ordered_malignant_val1];
...
feature_tr23_benign=[feature1_tr23_benign' feature2_tr23_benign' feature3_ordered_benign_tr23];
feature_val2_benign=[feature1_val2_benign' feature2_val2_benign' feature3_ordered_benign_val2];
feature_tr23_malignant=[feature1_tr23_malignant' feature2_tr23_malignant' feature3_ordered_malignant_tr23];
feature_val2_malignant=[feature1_val2_malignant' feature2_val2_malignant' feature3_ordered_malignant_val2];
%{
...
feature_tr13_benign=[feature1_tr13_benign' feature2_tr13_benign' feature3_ordered_benign_tr13];
feature_val3_benign=[feature1_val3_benign' feature2_val3_benign' feature3_ordered_benign_val3];
feature_tr13_malignant=[feature1_tr13_malignant' feature2_tr13_malignant' feature3_ordered_malignant_tr13];
feature_val3_malignant=[feature1_val3_malignant' feature2_val3_malignant' feature3_ordered_malignant_val3];
...
%}
for dim=32:1:32
[AUC1,Sens1,Spec1,Perf1]=train_data_DCIS(feature_tr12(:,1:dim),label_tr12,feature_val1(:,1:dim),label_val1);
[AUC2,Sens2,Spec2,Perf2]=train_data_DCIS(feature_tr23(:,1:dim),label_tr23,feature_val2(:,1:dim),label_val2);
[AUC3,Sens3,Spec3,Perf3]=train_data_DCIS(feature_tr13(:,1:dim),label_tr13,feature_val3(:,1:dim),label_val3);
...
save(strcat(path_save,'workspace_median_of_textons_BvsM_stained_15x15_matchedrois.mat'));
